...
const AudioPlayer: React.FC<Props> = (props) => {
  ...
  return (
    <button onClick={isAudioPlaying ? pauseAudio : playAudio} className='flex flex-row items-center justify-between w-2/5 p-8 px-20 transition duration-200 rounded-full bg-bgSec hover:shadow-inner hover:opacity-80'>
